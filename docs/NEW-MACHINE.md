...
Both carry a provenance comment naming the exact commit the content came
from — edit `rules/frontend-angular.md` and re-render, never a generated
file. See the README's [One rule set, every
